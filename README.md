...
- N3 means a noticeable-big change in the Compile part of project.
- N4 means a small change which can be noticed in the code in the Compile part of project.